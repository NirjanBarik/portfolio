        ...
        <div className="max-w-4xl mx-auto space-y-8">
          {education.map((edu, idx) => (
            <motion.div
              ...
              className="glass p-8 rounded-3xl border border-slate-700 hover:border-green-500/50 transition-all flex flex-col md:flex-row gap-6 group"
            >
              ...
              <div className="flex-1">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-2 mb-4">
                  <h3 className="text-xl font-bold text-white group-hover:text-green-400 transition-colors">{edu.degree}</h3>
                ...
                {edu.details && <p className="text-gray-500 text-sm italic">{edu.details}</p>}
              </div>
            </motion.div>
          ))}
        </div>
